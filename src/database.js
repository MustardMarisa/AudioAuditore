...
const URI = 'mongodb+srv://admin:admin@cluster0-ydygo.mongodb.net/test?retryWrites=true&w=majoritymongodb://localhost/mern-task';//direccion de la base de datos, en este caso una base local. Base llamada mern-tasks
